        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <h3>Manage Review <button type="button" class="btn btn-danger btn-sm" id="delete_record">Delete Data</button></h3>                    
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table" id="manage_blogs"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
                        <thead>
                            ...
                            <?php
                                  $sql=$review_list->all_review_list();
...
<script>
    ...
    function sendDeleteRequest(dataArr){
      $.ajax({
        type    : 'post',
        url     : 'webservices/ajax_delete_review.php',
        data    : {'data' : dataArr},
